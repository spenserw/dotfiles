...
require("nvim-treesitter").setup({
  ...
  ensure_installed = { "c", "lua", "glsl", "vim", "vimdoc", "python", "javascript", "ruby", "rust", "zig" }, -- Add/remove languages here
...
vim.lsp.enable({ "glsl_analyzer", "ruby_lsp", "rust-analyzer", "zls" })
