...
(custom-set-variables
 ...
 '(package-selected-packages
   '(nvm undo-tree typescript-mode tree-sitter-langs tsi helm-lsp lsp-treemacs company flycheck lsp-ui lsp-mode helm-projectile helm cask writeroom-mode yaml-mode json-mode tree-sitter tsc quelpa-use-package quelpa magit exec-path-from-shell hl-todo ## yasnippet tabbar olivetti glsl-mode evil-commentary oceanic-theme evil)))
(custom-set-faces
